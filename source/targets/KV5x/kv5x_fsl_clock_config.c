...
/*******************************************************************************
 ***************** Configuration clock_config_xtal_160mhz_run ******************
 ******************************************************************************/
/* clang-format off */
/* TEXT BELOW IS USED AS SETTING FOR TOOLS *************************************
!!Configuration
name: clock_config_xtal_160mhz_run
outputs:
...
/*******************************************************************************
 * Variables for clock_config_xtal_160mhz_run configuration
 ******************************************************************************/
const mcg_config_t mcgConfig_clock_config_xtal_160mhz_run =
    {
...
const sim_clock_config_t simConfig_clock_config_xtal_160mhz_run =
    {
        .pllFllSel = SIM_PLLFLLSEL_MCGFLLCLK_CLK, /* PLLFLL select: MCGFLLCLK clock */
        .er32kSrc = SIM_OSC32KSEL_OSC32KCLK_CLK,  /* OSC32KSEL select: OSC32KCLK clock */
        .clkdiv1 = 0x1370000U,                    /* SIM_CLKDIV1 - OUTDIV1: /1, OUTDIV2: /2, OUTDIV3: /4, OUTDIV4: /8 */
    };
const osc_config_t oscConfig_clock_config_xtal_160mhz_run =
    {
...
/*******************************************************************************
 * Code for clock_config_xtal_160mhz_run configuration
 ******************************************************************************/
void clock_config_xtal_160mhz_run(void)
{
    /* Set the system clock dividers in SIM to safe value. */
    CLOCK_CONFIG_SetSimSafeDivs();
    /* Initializes OSC0 according to board configuration. */
    CLOCK_InitOsc0(&oscConfig_clock_config_xtal_160mhz_run);
    CLOCK_SetXtal0Freq(oscConfig_clock_config_xtal_160mhz_run.freq);
    /* Configure FLL external reference divider (FRDIV). */
    CLOCK_CONFIG_SetFllExtRefDiv(mcgConfig_clock_config_xtal_160mhz_run.frdiv);
    /* Set MCG to PEE mode. */
    CLOCK_BootToPeeMode(kMCG_OscselOsc,
                        kMCG_PllClkSelPll0,
                        &mcgConfig_clock_config_xtal_160mhz_run.pll0Config);
    /* Configure the Internal Reference clock (MCGIRCLK). */
    CLOCK_SetInternalRefClkConfig(mcgConfig_clock_config_xtal_160mhz_run.irclkEnableMode,
                                  mcgConfig_clock_config_xtal_160mhz_run.ircs, 
                                  mcgConfig_clock_config_xtal_160mhz_run.fcrdiv);
    /* Set the clock configuration in SIM module. */
...
/*******************************************************************************
 **************** Configuration clock_config_xtal_188mhz_hsrun *****************
 ******************************************************************************/
/* clang-format off */
/* TEXT BELOW IS USED AS SETTING FOR TOOLS *************************************
!!Configuration
name: clock_config_xtal_188mhz_hsrun
outputs:
...
/*******************************************************************************
 * Variables for clock_config_xtal_188mhz_hsrun configuration
 ******************************************************************************/
const mcg_config_t mcgConfig_clock_config_xtal_188mhz_hsrun =
    {
        .mcgMode = kMCG_ModePEE,                  /* PEE - PLL Engaged External */
        .irclkEnableMode = kMCG_IrclkEnable,      /* MCGIRCLK enabled, MCGIRCLK disabled in STOP mode */
        .ircs = kMCG_IrcFast,                     /* Fast internal reference clock selected */
...
const sim_clock_config_t simConfig_clock_config_xtal_188mhz_hsrun =
    {
        .pllFllSel = SIM_PLLFLLSEL_MCGFLLCLK_CLK, /* PLLFLL select: MCGFLLCLK clock */
        .er32kSrc = SIM_OSC32KSEL_OSC32KCLK_CLK,  /* OSC32KSEL select: OSC32KCLK clock */
        .clkdiv1 = 0x1370000U,                    /* SIM_CLKDIV1 - OUTDIV1: /1, OUTDIV2: /2, OUTDIV3: /4, OUTDIV4: /8 */
...
/*******************************************************************************
 * Code for clock_config_xtal_188mhz_hsrun configuration
 ******************************************************************************/
void clock_config_xtal_188mhz_hsrun(void)
{
    ...
    CLOCK_CONFIG_SetSimSafeDivs();
    /* Initializes OSC0 according to board configuration. */
    CLOCK_InitOsc0(&oscConfig_clock_config_xtal_188mhz_hsrun);
    CLOCK_SetXtal0Freq(oscConfig_clock_config_xtal_188mhz_hsrun.freq);
    /* Configure FLL external reference divider (FRDIV). */
    CLOCK_CONFIG_SetFllExtRefDiv(mcgConfig_clock_config_xtal_188mhz_hsrun.frdiv);
    /* Set MCG to PEE mode. */
    CLOCK_BootToPeeMode(kMCG_OscselOsc,
                        kMCG_PllClkSelPll0,
                        &mcgConfig_clock_config_xtal_188mhz_hsrun.pll0Config);
    /* Configure the Internal Reference clock (MCGIRCLK). */
    CLOCK_SetInternalRefClkConfig(mcgConfig_clock_config_xtal_188mhz_hsrun.irclkEnableMode,
                                  mcgConfig_clock_config_xtal_188mhz_hsrun.ircs, 
                                  mcgConfig_clock_config_xtal_188mhz_hsrun.fcrdiv);
    /* Set the clock configuration in SIM module. */
