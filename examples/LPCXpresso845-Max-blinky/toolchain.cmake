...
## C flags
set(c_flags "${common_flags} -std=c11")

set(CMAKE_C_FLAGS                "${c_flags}"                CACHE STRING "" FORCE)
set(CMAKE_C_FLAGS_RELEASE        "${lto_flags} -Os -DNDEBUG" CACHE STRING "" FORCE)
set(CMAKE_C_FLAGS_MINSIZEREL     "${lto_flags} -Os -DNDEBUG" CACHE STRING "" FORCE)
set(CMAKE_C_FLAGS_RELWITHDEBINFO "-Og -g -DDEBUG"            CACHE STRING "" FORCE)
